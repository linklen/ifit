...
public class MyPickView extends View {

	public static final String TAG = "PickerView"; //传进来的·高度值，决定了绘制的字体大小，

	
	public static final float MARGIN_ALPHA = 5f;// text之间间距和minTextSize之比

	
	public static final float SPEED = 3;//自动回滚到中间的速度
	...
	public MyPickView(Context context)
	{
		super(context);
		init();
	}

	public MyPickView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}
